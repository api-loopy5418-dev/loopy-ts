...
exports.bdfdNodeInfo = bdfdNodeInfo;
const axios_1 = __importDefault(require("axios"));
const dotenv_1 = __importDefault(require("dotenv"));
const fs_1 = __importDefault(require("fs"));
const e = __importStar(require("../../errors"));
async function bdfdNodeInfo() {
    ...
    try {
        return await axios_1.default.get(`https://api.loopy5418.dev/bdfd-node-info?key=${key}`, {
            timeout: 3000
        });
    }
    catch (e) {
...
//# sourceMappingURL=bdfdNodeInfo.js.map